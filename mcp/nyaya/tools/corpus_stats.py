...
def register(mcp) -> None:
    @mcp.tool(
        ...
        description=(
            ...
            "schedules, cross_refs) and the as-of date. Use this to check "
    ...
    def corpus_stats() -> CorpusStats:
        ...
        return CorpusStats(
            ...
            articles=stats.get("article", 0),
            judgments=stats.get("judgment", 0),
            amendments=stats.get("amendment", 0),
            schedules=stats.get("schedule", 0),
